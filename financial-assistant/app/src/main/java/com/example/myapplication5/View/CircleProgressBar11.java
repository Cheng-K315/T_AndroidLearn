 ...
 */
public class CircleProgressBar11 extends View {
    ...
    private int mTargetProgress = CountOutcomeByMonthActivity.springSeason; //季节值
    ...
    public CircleProgressBar11(Context context) {
        super(context);
        init();
    }

    public CircleProgressBar11(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleProgressBar11(Context context, AttributeSet attrs, int defStyleAttr) {
