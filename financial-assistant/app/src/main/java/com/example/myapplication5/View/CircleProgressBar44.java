 ...
 */
public class CircleProgressBar44 extends View {
    ...
    private int mTargetProgress = CountOutcomeByMonthActivity.winterSeason; //季节值
    private int mMax = CountOutcomeByMonthActivity.mMax; // 总值
    private int mPercentage = (int)(mTargetProgress/(float)mMax*100);//百分比
    private int mWidth;
    private int mHeight;


    public CircleProgressBar44(Context context) {
        super(context);
        init();
    }

    public CircleProgressBar44(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleProgressBar44(Context context, AttributeSet attrs, int defStyleAttr) {
...
//       进度条颜色
        ...
        mFrontPaint.setColor(Color.MAGENTA);
