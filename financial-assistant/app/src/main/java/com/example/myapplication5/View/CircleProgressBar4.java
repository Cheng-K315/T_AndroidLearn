 ...
 */
public class CircleProgressBar4 extends View {
    ...
    //目标值，想改多少就改多少
    private int mTargetProgress = CountIncomeByMonth.winterSeason;
    ...
    public CircleProgressBar4(Context context) {
        super(context);
        init();
    }

    public CircleProgressBar4(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleProgressBar4(Context context, AttributeSet attrs, int defStyleAttr) {
